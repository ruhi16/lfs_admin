...
class AdminSessionFeesManagementComponent extends Component{
    ...
    // public function particularModalEditData($particularId){
    //     $this->particularModal = true;
    //     $this->editParticularId = $particularId;
    //     $this->particularName = FeeParticular::find($particularId)->name;
    // }
    ...
    //     try{
    //         if($this->editParticularId){
    //             FeeParticular::find($this->editParticularId)
    //                 ->update([
    //                     'name' => $validatedName['particularName'],
    //             ]);
    //         }else{
    ...
    //             ]);
    //         }
    //         Session::flash('success', 'Particular added successfully.');
    //     }catch(\Exception $e){
    //         Session::flash('error', $e->getMessage());
    //     }
    ...
    // public function deleteParticular($particularId){
    //     try{
    //         FeeParticular::find($particularId)->delete();
    //         Session::flash('success', 'Particular deleted successfully.');
    //     }catch(\Exception $e){
    //         Session::flash('error', $e->getMessage());
    //     }
    // }  
