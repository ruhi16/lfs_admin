...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2025 at 12:37 PM
...
--
-- Table structure for table `exam08_ansscr_dists`
--

CREATE TABLE `exam08_ansscr_dists` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `exam10_question_papers`
--

CREATE TABLE `exam10_question_papers` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `fee_collections` (
  ...
  `cat_part_ref` varchar(255) DEFAULT NULL,
...
CREATE TABLE `fee_collection_details` (
  ...
  `src_table_name` varchar(255) DEFAULT NULL,
...
CREATE TABLE `fee_structures` (
  ...
  `amount_type` enum('Yearly','Monthly','Half Yearly','Quarterly') DEFAULT NULL,
...
(67, '2025_06_06_082822_create_shop01_owners_table', 9),
(68, '2025_06_06_083156_create_shop02_categories_table', 9),
(69, '2025_06_06_083219_create_shop03_items_table', 9),
(70, '2025_06_06_083247_create_shop04_products_table', 9),
(71, '2025_06_06_084909_create_shop05_units_table', 9),
(72, '2025_06_06_084937_create_shop06_unit_refs_table', 9),
(73, '2025_06_06_084955_create_shop07_unit_ref_pts_table', 9),
(74, '2025_06_06_085100_create_shop08_purchases_table', 9),
(75, '2025_06_06_085134_create_shop09_purchase_products_table', 9),
(76, '2025_06_06_085200_create_shop10_sales_table', 9),
(77, '2025_06_06_085206_create_shop11_sale_products_table', 9),
(78, '2025_06_07_023346_create_shop12_sale_user_wishlists_table', 9),
(79, '2025_06_23_184547_create_exam01_names_table', 9),
(80, '2025_06_24_004628_create_exam02_types_table', 9),
(81, '2025_06_24_004722_create_exam03_parts_table', 9),
(82, '2025_06_24_005021_create_exam04_modes_table', 9),
(83, '2025_06_24_005049_create_exam05_details_table', 9),
(84, '2025_06_24_015033_create_exam06_class_subjects_table', 9),
(85, '2025_06_24_015159_create_exam07_ansscr_dists_table', 9),
(86, '2025_06_24_015512_create_exam08_ansscr_dists_table', 9),
(87, '2025_06_24_015750_create_exam09_schedule_rooms_table', 9),
(88, '2025_06_24_015939_create_exam10_marks_entries_table', 9),
(89, '2025_06_24_020117_create_exam10_question_papers_table', 9);
...
--
-- Dumping data for table `shop01_owners`
--

INSERT INTO `shop01_owners` (`id`, `name`, `email`, `phone`, `address`, `shop_name`, `shop_address`, `shop_phone`, `shop_email`, `shop_website`, `shop_logo`, `shop_banner`, `shop_description`, `created_at`, `updated_at`) VALUES
(1, 'LFS Shop', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Dumping data for table `shop02_categories`
--

INSERT INTO `shop02_categories` (`id`, `name`, `slug`, `description`, `image`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'Stationary', 'stationary', 'nothing', NULL, 1, '2025-06-24 03:37:13', '2025-06-24 03:37:13'),
(2, 'Food & Snacks', 'food', 'sdfsf', NULL, 1, '2025-06-24 03:37:30', '2025-06-24 03:37:30');
...
--
-- Dumping data for table `shop03_items`
--

INSERT INTO `shop03_items` (`id`, `name`, `slug`, `description`, `image`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'Khata', 'khata', 'khata', NULL, 1, '2025-06-24 03:37:39', '2025-06-24 03:37:39'),
(2, 'Kfgfgf', NULL, NULL, NULL, 1, '2025-06-25 01:09:21', '2025-06-25 01:09:21'),
(3, 'book', 'book', 'book', NULL, 1, '2025-06-25 01:09:53', '2025-06-25 01:09:53');
...
CREATE TABLE `shop04_products` (
  ...
  `color_bk` varchar(255) DEFAULT NULL,
  `color_fn` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `shop04_products`
--

INSERT INTO `shop04_products` (`id`, `name`, `slug`, `sku`, `tag`, `description`, `category_id`, `item_id`, `color_bk`, `color_fn`, `image_01`, `image_02`, `image_03`, `image_04`, `rating`, `review_count`, `is_active`, `owner_id`, `created_at`, `updated_at`) VALUES
(1, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, 0, 0, NULL, NULL, NULL),
(2, NULL, NULL, NULL, NULL, NULL, 1, 2, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, 0, 0, NULL, NULL, NULL),
(3, NULL, NULL, NULL, NULL, NULL, 2, 2, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, 0, 0, NULL, NULL, NULL),
(4, NULL, NULL, NULL, NULL, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, 0, 0, NULL, NULL, NULL),
(5, NULL, NULL, NULL, NULL, NULL, 3, 1, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, 0, 0, NULL, NULL, NULL);
...
--
-- Dumping data for table `shop05_units`
--

INSERT INTO `shop05_units` (`id`, `name`, `slug`, `description`, `unit_title`, `unit_code`, `unit_amount`, `is_active`, `owner_id`, `created_at`, `updated_at`) VALUES
(1, 'BOX', 'box', 'box', 'KG', 'KG', 5.000, 1, 1, '2025-06-24 09:16:54', '2025-06-24 09:16:54'),
(2, 'Packet', 'packet', 'packet', 'GM', 'GM', 250.000, 1, 1, '2025-06-24 09:16:54', '2025-06-24 09:16:54');
...
CREATE TABLE `shop06_unit_refs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `ref_type` enum('purchase','sale') DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  ...
  `prod_details` varchar(255) DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `shop08_purchases`
--

INSERT INTO `shop08_purchases` (`id`, `order_id`, `vendor_id`, `invoice_no`, `invoice_date`, `total_amount`, `adjust_amount`, `payable_amount`, `is_paid`, `paid_date`, `payment_method`, `remarks`, `is_active`, `owner_id`, `created_at`, `updated_at`) VALUES
(1, 100, 1002, 44, '2025-06-05', NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, 4, '2025-06-24 05:00:20', '2025-06-24 05:00:20'),
(2, 100, 1002, 234, '2025-06-25', 50.00, NULL, NULL, 0, NULL, NULL, NULL, 0, 4, '2025-06-25 00:59:18', '2025-06-25 00:59:18'),
(3, 100, 1002, 555, '2025-06-24', 274.00, NULL, NULL, 0, NULL, NULL, NULL, 0, 4, '2025-06-25 01:00:26', '2025-06-25 01:00:26'),
(4, 100, 1002, 567, '2025-06-25', 215.00, NULL, NULL, 0, NULL, NULL, NULL, 0, 4, '2025-06-25 01:01:19', '2025-06-25 01:01:19'),
(6, 100, 1002, 898, '2025-06-25', 162.00, NULL, NULL, 0, NULL, NULL, NULL, 0, 4, '2025-06-25 01:11:02', '2025-06-25 01:11:02');
...
CREATE TABLE `shop09_purchase_products` (
  ...
  `purchase_unit_rate` int(11) DEFAULT NULL,
  `purchase_unit_qty` int(11) DEFAULT NULL,
  `total_amount` decimal(10,2) DEFAULT NULL,
  `adjust_amount` decimal(10,2) DEFAULT NULL,
  `payable_amount` decimal(10,2) DEFAULT NULL,
...
--
-- Dumping data for table `shop09_purchase_products`
--

INSERT INTO `shop09_purchase_products` (`id`, `purchase_id`, `product_id`, `purchase_unit_id`, `purchase_unit_rate`, `purchase_unit_qty`, `total_amount`, `adjust_amount`, `payable_amount`, `is_paid`, `is_sale_unit_defined`, `is_active`, `owner_id`, `created_at`, `updated_at`) VALUES
(1, 2, 1, 1, 10, 5, NULL, NULL, NULL, 0, 0, 0, 4, '2025-06-25 00:59:18', '2025-06-25 00:59:18'),
(2, 3, 1, 2, 8, 8, NULL, NULL, NULL, 0, 0, 0, 4, '2025-06-25 01:00:26', '2025-06-25 01:00:26'),
(3, 4, 1, 2, 20, 10, NULL, NULL, NULL, 0, 0, 0, 4, '2025-06-25 01:01:19', '2025-06-25 01:01:19'),
(4, 3, 1, 2, 8, 8, NULL, NULL, NULL, 0, 0, 0, 4, '2025-06-25 01:00:26', '2025-06-25 01:00:26'),
(7, 6, 2, 2, 20, 6, NULL, NULL, NULL, 0, 0, 0, 4, '2025-06-25 01:11:02', '2025-06-25 01:11:02'),
(8, 6, 3, 1, 7, 6, NULL, NULL, NULL, 0, 0, 0, 4, '2025-06-25 01:11:02', '2025-06-25 01:11:02');
...
--
-- Dumping data for table `shop10_sales`
--

INSERT INTO `shop10_sales` (`id`, `studentcr_id`, `myclass_id`, `section_id`, `roll_no`, `total_amount`, `adjust_amount`, `payable_amount`, `is_paid`, `paid_date`, `payment_method`, `remarks`, `is_active`, `owner_id`, `created_at`, `updated_at`) VALUES
(1, 4, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, NULL, '2025-06-25 02:18:05', '2025-06-26 03:45:26');
...
CREATE TABLE `shop11_sale_products` (
  ...
  `product_id` int(11) DEFAULT NULL,
  `sale_unit_id` int(11) DEFAULT NULL,
  `sale_unit_rate` int(11) DEFAULT NULL,
  `sale_unit_qty` int(11) DEFAULT NULL,
  `total_amount` decimal(10,2) DEFAULT NULL,
  `adjust_amount` decimal(10,2) DEFAULT NULL,
  `payable_amount` decimal(10,2) DEFAULT NULL,
  `is_paid` tinyint(1) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `shop11_sale_products`
--

INSERT INTO `shop11_sale_products` (`id`, `sale_id`, `customer_id`, `product_id`, `sale_unit_id`, `sale_unit_rate`, `sale_unit_qty`, `total_amount`, `adjust_amount`, `payable_amount`, `is_paid`, `is_active`, `owner_id`, `created_at`, `updated_at`) VALUES
(1, 1, NULL, 1, NULL, NULL, 7, NULL, NULL, NULL, 0, 0, NULL, '2025-06-25 02:28:04', '2025-06-26 03:31:00'),
(2, 1, NULL, 4, NULL, NULL, 3, NULL, NULL, NULL, 0, 0, NULL, '2025-06-25 02:29:14', '2025-06-26 03:35:19');
...
CREATE TABLE `shop12_sale_user_wishlists` (
  ...
  `product_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `studentcr_id` varchar(255) DEFAULT NULL,
...
CREATE TABLE `ui_particulars` (
  ...
  `name` varchar(255) NOT NULL,
  `description` varchar(255) DEFAULT NULL,
  `particular_type` varchar(255) DEFAULT NULL,
  `order_index` int(10) UNSIGNED DEFAULT NULL,
  `school_id` int(10) UNSIGNED DEFAULT NULL,
  `session_id` int(10) UNSIGNED DEFAULT NULL,
  `user_id` int(10) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `ui_screen_designs` (
  ...
  `ui_particular_detail` varchar(255) DEFAULT NULL,
  `title` varchar(50) DEFAULT NULL,
  `sub_title` varchar(200) DEFAULT NULL,
  `details` varchar(1500) DEFAULT NULL,
  `img_ref_1` varchar(200) DEFAULT NULL,
  `img_ref_2` varchar(200) DEFAULT NULL,
  `img_ref_3` varchar(200) DEFAULT NULL,
  `by_whom` varchar(50) DEFAULT NULL,
  `by_whom_desig` varchar(50) DEFAULT NULL,
  `school_id` int(10) UNSIGNED DEFAULT NULL,
  `session_id` int(10) UNSIGNED DEFAULT NULL,
  `user_id` int(10) UNSIGNED DEFAULT NULL,
  `approved_by` int(10) UNSIGNED DEFAULT NULL,
...
--
-- Indexes for table `exam08_ansscr_dists`
--
ALTER TABLE `exam08_ansscr_dists`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `exam10_question_papers`
--
ALTER TABLE `exam10_question_papers`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `exam08_ansscr_dists`
--
ALTER TABLE `exam08_ansscr_dists`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `exam10_question_papers`
--
ALTER TABLE `exam10_question_papers`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
