<div class="bg-gray-100">
    ...
    {{-- Because she competes with no one, no one can compete with her. --}}
        ...
        <div id="flash-message" >
            {{-- class="fixed top-0 left-1/2 transform -translate-x-1/2 w-full max-w-md p-4 bg-white shadow-lg rounded-lg z-50 transition-opacity duration-500" --}}
            ...
            <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden group">
                ...
                <div class="px-4 py-4">
                    ...
                    <p class="text-gray-600 text-sm mb-2 line-clamp-2 h-[3rem]">
                        {{ $product->item->description ?? 'No Descriptioncription No Description No Description No Description No Description No Description '}}
                    </p>
                    ...
                    <div class="flex flex-col items-center justify-center space-y-2 gap-2 bg-slate-200">
                        <div class="flex flex-col sm:flex-row items-center justify-between w-full">
                            ...
                            <span class="text-2xl font-bold text-green-600 mb-0 sm:mb-0">₹ {{ $product->price ?? '0.00' }}</span>
                        </div>
