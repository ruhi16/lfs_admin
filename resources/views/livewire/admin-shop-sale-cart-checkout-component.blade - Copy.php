                        ...
                        <div class="space-y-2 mb-4 max-h-96 overflow-y-auto">
                            ...
                            <div class="flex-1 min-w-0 ">
                                ...
                                <div class="flex border border-gray-300 rounded-md">
                                    <button 
                                        class="w-6 h-6 flex items-center justify-center rounded-l bg-gray-100 text-gray-600 hover:bg-gray-200 focus:outline-none transition-colors"> - </button>
                                    <span class="w-8 h-6 flex items-center justify-center bg-white text-xs text-gray-800">2</span>
                                    <button 
