<div>
    ...
    <div class="relative flex flex-col w-full p-4 text-gray-700 bg-white shadow-md rounded-lg bg-clip-border">
    ...
    <div
        ...
        <div class="flex justify-between p-4">
            ...
            <!-- Page Size Selector -->
            <div>
                <select id="pageSizeSelector" class="p-2 border border-slate-300 rounded-lg">
        ...
        <table class="w-full text-left table-auto min-w-max">
            <thead>
                <tr>
                    <th class="p-4 border-b border-slate-300 bg-slate-50">
                        <p class="block text-xl font-normal leading-none text-slate-500">Sl</p>
                    </th>
                    <th class="p-4 border-b border-slate-300 bg-slate-50">
                        <p class="block text-xl font-normal leading-none text-slate-500">Reg No</p>
                    </th>

                    <th class="p-4 border-b border-slate-300 bg-slate-50">
                        <p class="block text-xl font-normal leading-none text-slate-500">Details</p>

                    </th>
                    <th class="p-4 border-b border-slate-300 bg-slate-50">
                        <p class="block text-lg font-normal leading-none text-slate-500">Class Details</p>
                    </th>
                    <th class="p-4 border-b border-slate-300 bg-slate-50">
            ...
            <tbody id="tableBody">
                ...
                @foreach($studentcrs as $studentcr)
                    ...
                    <tr class="hover:bg-slate-50">
                        <td class="p-4 border-b border-slate-200">
                            <p class="block text-lg text-slate-800">{{ $loop->iteration }}</p>
                        </td>
                        <td class="p-4 border-b border-slate-200">
                            <p class="block text-lg text-slate-800">{{$studentcr->studentdb->uuid_auto}}-{{ $studentcr->studentdb_id }}-{{ $studentcr->id }}</p>
                        </td>

                        <td class="p-4 border-b border-slate-200">
                            <p class="block text-xl font-normal leading-none text-slate-500">{{ $studentcr->studentdb->name }}</p>
                        </td>
                        <td class="p-4 border-b border-slate-200">
                        ...
                        <td class="p-4 border-b border-slate-200">
                            <p class="block text-lg font-normal leading-none text-slate-500">
                                <a href="javascript:void(0)" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Edit</a> |
                                <a href="javascript:void(0)" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">Delete</a>
                            </p>
                        </td>
                    </tr>
                ...
                {{-- <tr class="hover:bg-slate-50">
                    ...
                    <td class="p-4 border-b border-slate-200">
                        <p class="block text-xl font-normal leading-none text-slate-500">Name</p>
                        <p class="block text-xl font-normal leading-none text-slate-500">DoB: Aadhar: </p>
                        <p class="block text-xl font-normal leading-none text-slate-500">Father Name</p>
                        <p class="block text-xl font-normal leading-none text-slate-500">Mother Name</p>
                        <p class="block text-xl font-normal leading-none text-slate-500">Mobile No</p>
                    </td>
                    <td class="p-4 border-b border-slate-200">
    ...
    <div id="modal" class="fixed inset-0 z-50 overflow-y-auto hidden">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <!-- Modal Content -->
            <div
                class="inline-block max-w-full p-4 align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                <!-- Modal Header -->
