    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-64 bg-gray-800 text-white">
          ...
          <nav class="mt-4">
            <ul>
              <!-- Dashboard Item -->
              <li class="px-4 py-3 hover:bg-gray-700 cursor-pointer">
              ...
              <li class="menu-item px-4 py-3 hover:bg-gray-700 cursor-pointer">
                <div class="flex items-center justify-between" onclick="this.parentElement.classList.toggle('active')">
                  <div class="flex items-center">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <svg class="w-4 h-4 menu-arrow transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                  </svg>
                </div>
                <ul class="submenu pl-10 bg-gray-900">
                  <li class="py-2 hover:text-gray-300">All Users</li>
                  <li class="py-2 hover:text-gray-300">Add New</li>
                  <li class="py-2 hover:text-gray-300">User Roles</li>
                </ul>
              </li>
              ...
              <li class="menu-item px-4 py-3 hover:bg-gray-700 cursor-pointer">
                ...
                <ul class="submenu pl-10 bg-gray-900">
                  <li class="py-2 hover:text-gray-300">All Products</li>
                  <li class="py-2 hover:text-gray-300">Add Product</li>
                  <li class="py-2 hover:text-gray-300">Categories</li>
                  <li class="py-2 hover:text-gray-300">Inventory</li>
                </ul>
              </li>
        ...
        <div class="flex-1 p-8">
          <h1 class="text-2xl font-semibold">Main Content Area</h1>
          <p class="mt-4">Click on Users or Products in the sidebar to see the submenu options.</p>
        </div>
      </div>
</another>
